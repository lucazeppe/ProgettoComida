...
STRINGS = {
    "it": {
        ...
        "button_export_reminders": "Scarica export solleciti (anomalie)",
    ...
    "es": {
        ...
        "button_export_reminders": "Descargar exportación de avisos (anomalías)",
